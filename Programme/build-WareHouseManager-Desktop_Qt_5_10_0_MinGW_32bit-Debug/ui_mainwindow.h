...
public:
    ...
    QWidget *tab_4;
    QLabel *labelRowId;
    QPushButton *pushButtonRecupererRowId;
    QLineEdit *lineEditCodeArticlePourRowId;
    QMenuBar *menuBar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayoutWidget_4->setGeometry(QRect(40, 60, 652, 304));
        ...
        gridLayout_4->addWidget(afficheDesignationArticle, 1, 1, 1, 1);
        ...
        gridLayout_4->addWidget(afficheEmplacementArticle, 3, 1, 1, 1);
        ...
        gridLayout_4->addWidget(affichePoidsArticle, 2, 1, 1, 1);
        ...
        labelRowId = new QLabel(tab_4);
        labelRowId->setObjectName(QStringLiteral("labelRowId"));
        labelRowId->setGeometry(QRect(210, 110, 47, 13));
        pushButtonRecupererRowId = new QPushButton(tab_4);
        pushButtonRecupererRowId->setObjectName(QStringLiteral("pushButtonRecupererRowId"));
        pushButtonRecupererRowId->setGeometry(QRect(100, 100, 75, 23));
        lineEditCodeArticlePourRowId = new QLineEdit(tab_4);
        lineEditCodeArticlePourRowId->setObjectName(QStringLiteral("lineEditCodeArticlePourRowId"));
        lineEditCodeArticlePourRowId->setGeometry(QRect(100, 60, 113, 20));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        lineEditModificationPoidsArticle->setInputMask(QApplication::translate("MainWindow", "9999.99", nullptr));
        ...
        labelRowId->setText(QApplication::translate("MainWindow", "TextLabel", nullptr));
        pushButtonRecupererRowId->setText(QApplication::translate("MainWindow", "RowId", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("MainWindow", "ROWID", nullptr));
    } // retranslateUi
